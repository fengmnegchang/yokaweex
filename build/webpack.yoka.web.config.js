...
var webSrcDirectory = path.join(__dirname, '../yoka/web-entry');
...
function walk(dir) {
  dir = dir || '.';
  var directory = path.join(__dirname, '../yoka', dir);
  ...
  fs.readdirSync(directory)
    .forEach(function(file) {
      ...
      if (stat.isFile() && extname === '.vue') {
        ...
        var name = path.join('yoka', 'build/vue-web', /*path.relative('vue', dir)*/dir, path.basename(file, extname));
